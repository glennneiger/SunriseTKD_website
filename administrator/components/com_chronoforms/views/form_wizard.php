...
<?php echo $DragTabsHelper->tabStart('elements'); ?>
      <div id="elements_accordion"> <a href="#" class="toggler element_toggler">Elements</a>
        <div id="elements_accordion_pane" class="elements_list elements_accordion_pane">
          <div class="half first_half">
		    ...
		    <?php foreach($form_elements as $form_element): ?>
			    ...
			    <?php if($counter >= count($form_elements)/2): $counter = -count($form_elements); ?>
			    	</div><div class="half">
			    <?php endif; ?>
		    <?php endforeach; ?>
          </div>
        </div>
        <!--<a href="#" class="toggler element_toggler">Field Settings</a>-->
        <!--<div class="settings elements_accordion_pane" id="field_settings" style="display:none;"></div>-->
