...
<div class="element_code" id="cfaction_authenticator_element">
	...
	<!--
	<textarea name="chronoaction[{n}][action_authenticator_{n}_content1]" id="action_authenticator_{n}_content1" style="display:none"><?php echo $action_params['content1']; ?></textarea>
    -->
