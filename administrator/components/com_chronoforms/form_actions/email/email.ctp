...
<div class="element_config" id="cfaction_email_element_config">
	<?php echo $PluginTabsHelper->Header(array('general' => 'General', 'template' => 'Template', 'static' => 'Static', 'dynamic' => 'Dynamic'), 'email_config_{n}'); ?>
	...
	<?php echo $PluginTabsHelper->tabStart('template'); ?>
		...
		<?php echo $HtmlHelper->input('action_email_{n}_content1_config', array('type' => 'textarea', 'label' => "Template", 'class' => 'text_editor', 'label_over' => true, 'rows' => 20, 'cols' => 70, 'smalldesc' => 'You may use the curly brackets formula to get fields data from the form data array, e.g: {field_name}.<br /><br /> You may also use PHP but if you enable the editor your PHP code will be stripped.')); ?>
