...
<div class="element_code" id="cfaction_auto_serverside_validation_element">
	...
	<!--
	<textarea name="chronoaction[{n}][action_auto_serverside_validation_{n}_content1]" id="action_auto_serverside_validation_{n}_content1" style="display:none"><?php echo $action_params['content1']; ?></textarea>
    -->
