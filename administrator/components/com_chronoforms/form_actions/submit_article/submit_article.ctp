...
<div class="element_config" id="cfaction_submit_article_element_config">
	...
	<?php echo $PluginTabsHelper->tabStart('fields'); ?>
		...
		<?php echo $HtmlHelper->input('action_submit_article_{n}_fulltext_config', array('type' => 'text', 'label' => "Full Text Field", 'class' => 'medium_input', 'smalldesc' => "The field name which will hold the article's intro text.")); ?>
		<?php echo $HtmlHelper->input('action_submit_article_{n}_introtext_config', array('type' => 'text', 'label' => "Intro Text Field", 'class' => 'medium_input', 'smalldesc' => "The field name which will hold the article's text.")); ?>
