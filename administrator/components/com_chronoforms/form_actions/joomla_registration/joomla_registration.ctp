<div class="dragable" id="cfaction_joomla_registration">Registration</div>
<!--start_element_code-->
<div class="element_code" id="cfaction_joomla_registration_element">
	<label class="action_label" style="display: block; float:none!important;">Registration</label>
...
<div class="element_config" id="cfaction_joomla_registration_element_config">
	<?php echo $PluginTabsHelper->Header(array('fields' => 'Fields', 'settings' => 'Settings', 'help' => 'Help'), 'joomla_registration_config_{n}'); ?>
